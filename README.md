...
| [WN10-CC-000038](https://github.com/malaya-m/Win10-STIG-Remediation/blob/main/stig-overview/WN10-CC-000038.md)                              | [`Disable-WDigest.ps1`](./scripts/Disable-WDigest.ps1)              | Disables WDigest authentication to prevent storage of plain-text credentials in memory. |
| [WN10-CC-000180](https://github.com/malaya-m/Win10-STIG-Remediation/blob/main/stig-overview/WN10-CC-000180.md) / [-000185](https://github.com/malaya-m/Win10-STIG-Remediation/blob/main/stig-overview/WN10-CC-000185.md) / [-000190](https://github.com/malaya-m/Win10-STIG-Remediation/blob/main/stig-overview/WN10-CC-000190.md)          | [`Disable-AutoPlay.ps1`](./scripts/Disable-AutoPlay.ps1)           | Disables AutoPlay and AutoRun features across all drives to prevent malware propagation. |
| [WN10-AU-000500](https://github.com/malaya-m/Win10-STIG-Remediation/blob/main/stig-overview/WN10-AU-000500.md) / [-000505](https://github.com/malaya-m/Win10-STIG-Remediation/blob/main/stig-overview/WN10-AU-000505.md) / [-000510](https://github.com/malaya-m/Win10-STIG-Remediation/blob/main/stig-overview/WN10-AU-000510.md)          | [`Set-EventLogSize.ps1`](./scripts/Set-EventLogSize.ps1)           | Configures Application, Security, and System logs to meet minimum size requirements (32MB, 1000MB, 32MB). |
| [WN10-AC-000005](https://github.com/malaya-m/Win10-STIG-Remediation/blob/main/stig-overview/WN10-AC-000005.md) / [-000010](https://github.com/malaya-m/Win10-STIG-Remediation/blob/main/stig-overview/WN10-AC-000010.md) / [-000015](https://github.com/malaya-m/Win10-STIG-Remediation/blob/main/stig-overview/WN10-AC-000015.md)          | [`Set-AccountLockoutPolicy.ps1`](./scripts/Set-AccountLockoutPolicy.ps1)   | Enforces account lockout settings: 3 attempts, 15-minute duration and reset period. |
...
| [WN10-AC-000030](https://github.com/malaya-m/Win10-STIG-Remediation/blob/main/stig-overview/WN10-AC-000030.md)                              | [`Set-MinimumPasswordAge.ps1`](./scripts/Set-MinimumPasswordAge.ps1)     | Ensures users cannot change passwords repeatedly in a short time to bypass history restrictions. |
---
